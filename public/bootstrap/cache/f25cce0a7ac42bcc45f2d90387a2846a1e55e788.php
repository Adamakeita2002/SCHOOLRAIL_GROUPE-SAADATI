    ...
    <div class="app">
      ...
      <div class="container-fluid"> <!-- container-fluid-->
          <div class="row">
            ...
            <form  action="/kuro/admin/CreateSubject" method="post" enctype="multipart/form-data">
              <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="semester_id">
                    <option value="<?php echo e($semesterP->id); ?>"><?php echo e($semesterP->label); ?>  </option>
                  </select>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card h-100">
              ...
              <br><br>
              <p class="text-center">
                <a href="/kuro/admin/affectSubject"><b>Cliquer ici pour aller à l'affectation</b></a>
              </p>
              <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/admin/subject.blade.php ENDPATH**/ ?>