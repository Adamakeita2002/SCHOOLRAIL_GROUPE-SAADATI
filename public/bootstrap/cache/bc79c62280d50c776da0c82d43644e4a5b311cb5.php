      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item " aria-current="page">Elève - Absence</li>
        ...
        <?php
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <hr>
                ...
                <p class="text-center">
                    <a href="/teacher/absence?q=<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>" class="btn btn-danger text-center"> <b>POINTER LES ABSENCES</b>  </a>
                </p>
                
                <p class="text-center">
                    <a href="/teacher/VoirAbsenceStudentClas?q=<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>" class="btn btn-success text-center"> <b>VOIR LES ABSENCES</b>  </a>
                </p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/AbsenceStudentClas.blade.php ENDPATH**/ ?>