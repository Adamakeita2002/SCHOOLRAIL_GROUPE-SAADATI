...
<body>
    <div class="container">
        ...
        <form action="<?php echo e(route('teacherstore')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/insert.blade.php ENDPATH**/ ?>