  ...
  <?php $quiz="activve" ;?>
      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo e($specSubject->name); ?> en <?php echo e($specSubject->classroom->name); ?> </li>
          </ol>
        </nav>
    ...
    <div class="col-md-8">
      ...
      <h1 class="my-4 card-header text-center bg-primary text-white">QUESTIONS / REPONSES <br>
        <b>(<?php echo e($specSubject->name); ?>)</b> <br>
        <b>(<?php echo e($specSubject->classroom->name); ?>)</b>
      </h1>

<?php if($specSubject->questions): ?>

        <?php if($specSubject->questions->count() <= 0): ?>
        <p class="text-center">
...
<?php endif; ?>
  <!-- Blog Post -->
        <?php if(is_array($specSubject->questions) || is_object($specSubject->questions)): ?>
            <?php $__currentLoopData = $specSubject->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-sm-9">
                          <form  action="/teacher/CreateQcomment" method="post" enctype="multipart/form-data" id="theform">
                            ...
                            <div class="form-group">
                              ...
                              <input type="hidden" value="<?php echo e($question->subject->id); ?>" name="link">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/specQuiz.blade.php ENDPATH**/ ?>