      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Rechercher une classe</li>
          </ol>
        </nav>
...
<!--
            <div class="form-group">
              ...
              <select class="form-control" name="classroom" onchange="showTimetable(this.value)">
                ...
                <?php  array_push($Class,$subject->classroom->id);  ?>
                  <?php if(in_array($subject->classroom->id , $Class) AND count($Class) <=1 ): ?>
                  <option value="<?php echo e($subject->classroom->id); ?>"><?php echo e($subject->classroom->name); ?></option>
                  <?php endif; ?>
...
<img class=" img-thumbnail card-img-top mx-auto d-block" src="/files/timetable/<?php echo e($UniqueClassrooms[$i]); ?>" style="width:1100px; height: 800px;" alt="<?php echo e($UniqueClassrooms[$i]); ?>" >
...
function showTimetable(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/teacher/getTimetable?q="+str,true);
        xmlhttp.send();
    }
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/findTimetable.blade.php ENDPATH**/ ?>