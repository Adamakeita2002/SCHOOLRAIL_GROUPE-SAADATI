...
<?php if($Nstudents->count() >0): ?>
 <!-- Page Heading -->
  <h4 class="my-4 text-center">LISTE DES ETUDIANTS NON AFFECTES</h4>
        ...
        <form action="<?php echo e(URL::to('/manager/affectationStudent')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/affectStudent.blade.php ENDPATH**/ ?>