        ...
        <div class="row">
                ...
                <div class="col-sm-8 mt-3">
                    ...
                    <!--  <p class="card-text">Etudiant en Informatique Developpeur d'Application </p>-->
                      ...
                      <div class="row">
                          ...
                          <h6><b>Email: </b><br><span style="font-size: 14px"><?php echo e($student->email); ?></span> </h6>

                          <h6><b>Telephone:</b> <br><span style="font-size: 14px"><?php echo e($student->tel); ?></span> </h6>

                          </div>

                          <div class="col-sm-6">

                          <h6><b>Filière:</b><br> <span style="font-size: 14px"><?php echo e($student->classroom->program->fullname); ?></span> </h6>

                          <h6><b>Classe:</b><br> <span style="font-size: 14px"><?php echo e($student->classroom->name); ?>
          ...
          <div class="row">
            ...
            <div class="col-sm-4 pt-2">
                ...
                <h3 class="text-center " style="color:white;"> <b><?php if($semesterAvg): ?> <?php echo e($semesterAvg->value); ?> <?php else: ?> PAS DISPONIBLE <?php endif; ?> </b></h3>

                <h3 class="text-center  mt-1" style="color:white;">Rang : <b><?php if($semesterAvg): ?> <?php echo e($semesterAvg->rank); ?> <?php else: ?> PAS DISPONIBLE <?php endif; ?></b> </h3>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_GROUPE SAADATI\resources\views/student/profile.blade.php ENDPATH**/ ?>