    ...
    <div class="app">
      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter (x) étudiants</li>
          </ol>
        </nav>
      ...
      <div class="container-fluid"> <!-- container-fluid-->
          <div class="row">
            ...
            <form  action="/kuro/admin/CreateManyStudent" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <?php $semester= $academicyearP->semesters->where('state','process')->first();
                         ...
                         ?>
                          ...
                          <?php else: ?>
                          <span class="badge badge-danger">IMPOSSIBLE DE CREER UN ETUDIANT PENDANT LE SECOND SEMESTRE OU <br> PENDANT QUE LES NOTES SONT ARRETEES</span>
                          <?php endif; ?>
                      </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_GROUPE SAADATI\resources\views/admin/studentMany.blade.php ENDPATH**/ ?>