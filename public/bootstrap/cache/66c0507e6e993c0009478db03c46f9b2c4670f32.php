 ...
 */
  ...
  xhttp.open("GET","/manager/getStudent1?q="+student1,true);
  xhttp.send();
}
...
function showStudent2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getStudent2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showStudent3() {
  ...
  xhttp.open("GET","/manager/getStudent3?q="+student3+"&qq="+student4,true);
  xhttp.send();
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/findStudent.blade.php ENDPATH**/ ?>