            ...
            <div class="card h-100">
              <div class="card-body bg-primary">
                <h2 class="card-title text-center mt-2" style="color:white;">
                 <?php echo e($homework->classroomName); ?>

                </h2>
              </div>
              <div class="card-body">
                <h4 class="card-title text-center">
                  <?php echo e($subjects->where('id',$homework->subject_id)->pluck('name')->first()); ?> (<?php echo e($homework->testNum); ?>)
                </h4>
                <div class="row">
                  <div class="col-sm-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/homework.blade.php ENDPATH**/ ?>