              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control" required>
                    ...
                    <option value="<?php echo e($teacher->email); ?>"><?php echo e($teacher->fullname); ?> (<?php echo e($teacher->email); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                   </label>
                  </datalist>
 ...
 */
  ...
  xhttp.open("GET","/manager/getTeacher1?q="+teacher1,true);
  xhttp.send();
}
...
function showTeacher2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getTeacher2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showTeacher3() {
  ...
  xhttp.open("GET","/manager/getTeacher3?q="+teacher3,true);
  xhttp.send();
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/findTeacher.blade.php ENDPATH**/ ?>