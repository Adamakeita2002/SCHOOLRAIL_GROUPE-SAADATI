    ...
    <div class="app">
      ...
      <div class="container-fluid"> <!-- container-fluid-->
          <div class="row">
            ...
            <form  action="/manager/CreateStudent" method="post" enctype="multipart/form-data" id="theform">
      ...
      <div class="col-sm-2">
        ...
        <img src="/assets/img/img_avatar1.png" width="100" height="100" class="rounded-circle mx-auto d-block">
          <h4 class="card-title text-center " style="color:white;">
           <?php echo e($Ustudent->name); ?> <?php echo e($Ustudent->surname); ?>

          </h4>
          <hr>
          <h4 class="card-title text-center " style="color:white;">
           <b><?php echo e($Ustudent->matricule); ?></b>
          </h4>
        </div>
        ...
        <div class="col-sm-5">
          <div class="card-body">
            ...
            <?php if( !empty($Ustudent->classroom_id)): ?>
            <span><?php echo e($Ustudent->classroom->name); ?></span>
            <?php else: ?>
        ...
        <hr>
              <h4 class="card-title " ><b> Nationalité :  </b>
                <span><?php echo e($Ustudent->nationality); ?></span>
              </h4>
        <hr>
        ...
        <hr>
             <h4 class="card-title " ><b> Genre : </b>
              <span><?php if($Ustudent->gender=='M'): ?> Masculin <?php elseif($Ustudent->gender=='F'): ?> Feminin  <?php endif; ?></span>
            </h4>
          ...
          <div class="col-sm-5">
            <div class="card-body">
                <h4 class="card-title " ><b> Email : </b>
                  <span><?php echo e($Ustudent->email); ?></span>
                </h4>
          <hr>
                <h4 class="card-title " ><b> Téléphone : </b>
                  <span><?php echo e($Ustudent->tel); ?></span>
                </h4>
          <hr>

                <h4 class="card-title " ><b> Adresse : </b>
                  <span><?php echo e($Ustudent->address); ?></span>
                </h4>
          <hr>
...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <div class="col-sm-6"><!-- COL 6 -->
      ...
      <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MM1<?php echo e($Ustudent->id); ?>" ><b>MODIFIER</b></button></p> <!-- MODIFY BUTTON -->

    <!-- Modal Edit student -->
    <div class="modal fade" id="MM1<?php echo e($Ustudent->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit student -->
    <form action="<?php echo e(URL::to('/manager/modifyStudent')); ?>" method="post" enctype="multipart/form-data" id="theform2">
      <!--EDIT FORM-->
      <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
        ...
        <div class="modal-content"> <!--MODAL CONTENT -->
          <div class="modal-header"> <!--MODAL HEADER -->
              <h5 class="modal-title" id="exampleModalLabel">Modifier les informations concernant cet étudiant
                <b><?php echo e($Ustudent->name); ?> <?php echo e($Ustudent->surname); ?></b>
              </h5>
            ...
            <div class="row"> <!--MODAL ROW -->
              ...
              <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="<?php echo e($Ustudent->name); ?>" class="form-control">
                  </div>

                  <div class="form-group">
                    <label><b>Modifier le prénom(s) de l' étudiant</b></label>
                    <input type="text" name="surname" placeholder="<?php echo e($Ustudent->surname); ?>" class="form-control">
                  </div>

                  <div class="form-group">
                    <label><b>Date de naissance de l' étudiant (<?php echo e($Ustudent->dateofbirth); ?>)</b></label>
                    <input type="date" name="dateofbirth"  class="form-control">
                  </div>

                  <div class="form-group">
                    <label><b>Modifier la nationalité de l' étudiant</b></label>
                    <input type="texte" name="nationality" placeholder="<?php echo e($Ustudent->nationality); ?>" class="form-control">
                  </div>
              ...
              <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="gender">
                          <option value="">Genre (<?php echo e($Ustudent->gender); ?>)</option>
                          <option value="M">Masculin</option>
                          <option value="F">Féminin</option>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" placeholder="<?php echo e($Ustudent->email); ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label><b>Modifier le contact de l' étudiant</b></label>
                        <input type="number" name="tel" placeholder="<?php echo e($Ustudent->tel); ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label><b>Modifier l'adresse de l' étudiant</b></label>
                        <input type="texte" name="address" placeholder="<?php echo e($Ustudent->address); ?>" class="form-control">
                      </div>


                      <input type="hidden" class="form-control" name="id" value="<?php echo e($Ustudent->id); ?>" hidden="">
  ...
  $(function()
{
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD1<?php echo e($Ustudent->id); ?>" ><b>SUPPRIMER</b></button></p>

      <!-- Modal Delete student -->
      <div class="modal fade" id="MD1<?php echo e($Ustudent->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form action="<?php echo e(URL::to('/manager/deleteStudent')); ?>" method="post" enctype="multipart/form-data" id="theform3">
        <!--DELETE FORM-->
        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/student.blade.php ENDPATH**/ ?>