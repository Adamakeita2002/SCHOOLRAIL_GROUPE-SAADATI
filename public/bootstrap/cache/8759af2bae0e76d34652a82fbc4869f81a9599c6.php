    ...
    <div class="app">
      ...
      <div class="col-md-3">
       ...
       <div class="col-md-5">
          ...
          <?php if($teacher->subjects->count() >=1): ?>
                ...
                <label><b>Sélectionner la classe</b></label>
                  ...
                  <div class="form-group options ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" required id="c<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>" value="<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>"/>
                          <span class="check-mark"></span><?php echo e($UniqueClassrooms[$i]); ?>
    ...
    return true;
              ...
              <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
                ...
                <label><b>Sélectionner la classe</b></label>
                  ...
                  <div class="form-group options">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" required name="classroom[]" id="c<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>" value="<?php echo e($classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()); ?>"/>
                          <span class="check-mark"></span><?php echo e($UniqueClassrooms[$i]); ?>
        ...
        <div class="table-responsive">
            ...
            <?php $__currentLoopData = $ressources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ressource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <?php if($ressource->classrooms->count() > 0): ?>
                <b>Classe(s):</b>
                ...
                <?php if($ressource->students->count() > 0): ?>
                <b>Elève(s):</b>
                <?php $__currentLoopData = $ressource->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($student->name); ?> <?php echo e($student->surname); ?> <b>(<?php echo e($student->classroom->name); ?>)</b> -
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
                </p>
              ...
              <div class="modal fade" id="R<?php echo e($ressource->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="<?php echo e(URL::to('/teacher/DeleteRessource')); ?>" method="post" enctype="multipart/form-data" id="theform3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/ressource.blade.php ENDPATH**/ ?>