...
<hr>
 <!-- Page Heading -->
  <h4 class="my-4 text-center">RETROUVER UN ETUDIANT</h4>
          ...
          <div class="col-12 col-lg-6">
            <div class="row">
              <div class="col-12 col-md-6 ">
                <div class="form-group">
                  <label>Selectionner la classe de l'étudiant</label>
        ...
        <div class="row"> <!-- START ROW -->
          ...
          <div class="col-12 col-lg-6">
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group">
                <label for =""> Entrer le nom de l'étudiant</label>
                  <input required="" class="form-control" type="text" id="student3" placeholder="Nom "  >
                </div>
              </div>

              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group">
                <label for =""> Entrer le prénom de l'étudiant</label>
                  <input required="" class="form-control" type="text" id="student4" placeholder="Prénom"  >
                </div>
              </div>

              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group mt-4">
                   <input class="btn btn-primary btn-lg btn-block" type="submit" onclick="showStudent3();" value="RECHERCHER"> 
                </div>
              </div>
            </div>
          </div>
 ...
 */
  ...
  xhttp.open("GET","/kuro/admin/getStudent1?q="+student1,true);
  xhttp.send();
}
...
function showStudent2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/kuro/admin/getStudent2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showStudent3() {
  
  var s3 = document.getElementById('student3');
  var student3 = s3.value ;

  var s4 = document.getElementById('student4');
  var student4 = s4.value ;
  ...
  xhttp.open("GET","/kuro/admin/getStudent3?q="+student3+"&qq="+student4,true);
  xhttp.send();
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_GROUPE SAADATI\resources\views/admin/findStudent.blade.php ENDPATH**/ ?>