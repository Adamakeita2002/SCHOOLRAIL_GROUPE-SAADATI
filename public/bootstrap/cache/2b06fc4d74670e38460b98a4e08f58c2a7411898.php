            ...
            <div class="app-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <form action="/teacher/CreateTest" method="post" enctype="multipart/form-data" id="theform">
                                ...
                                <input type="hidden" class="form-control" name="semester_id" value="<?php echo e($semesterP->id); ?>"
                                    hidden="">
                                    ...
                                    <select class="form-control" name="subject_id" required>
                                        ...
                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($subject->arretDesNotes == 0 and $subject->classroom->students->count() !== 0): ?>
                                                <option value="<?php echo e($subject->id); ?>"><?php echo e($subject->classroom->name); ?> /
                    ...
                    <?php if(session('status01')): ?>
                        <div align="center">
                            <div class="alert alert-danger text-center">
                                ...
                                <span class="badge badge-danger" style="font-size: 15px;"> <?php echo e(session('status01')); ?>
                    ...
                    <?php if(session('status02')): ?>
                        <div align="center">
                            <div class="alert alert-danger text-center">
                                ...
                                <span class="badge badge-danger" style="font-size: 15px;"> <?php echo e(session('status02')); ?>
                    ...
                    <?php for($i = 0; $i < count($UniqueSubjTests); $i++): ?>
                        ...
                        <div class="accordion" id="accordion<?php echo $i; ?>">
                            <div class="card " style="background-color:#bbf59d;">
                                <div class="card-header <?php if($subject->arretDesNotes == 0): ?> bg-secondary <?php endif; ?> "
                                    style="<?php if($subject->arretDesNotes == 1): ?> background-color:#26bc2c; <?php endif; ?>"
                                    ...
                                    <h2 class=" text-center mb-0">
                                        <button class="btn btn-primary" type="button" data-toggle="collapse"
                                            ...
                                            <!-- <?php echo e($academicyearP->labelYear); ?> /--> <?php echo e($semesterP->label); ?> /
                                            <?php echo e($subject->classroom->name); ?>
                                        ...
                                        <div class="card-body">
                                            <table class="table ">
                                                <thead class="thead ">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php $__currentLoopData = $epreuves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $epreuve): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <span
                                                                    class="<?php if($epreuve->id == 1): ?> badge badge-primary <?php elseif($epreuve->id == 2): ?> badge badge-success <?php else: ?> badge badge-dark <?php endif; ?>"
                                                                    style="font-size: 20px"><?php echo e($epreuve->name); ?></span>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <span class="badge"
                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="<?php echo e(URL::to('/teacher/CreateMark')); ?>" method="post"
                                                        ...
                                                        <?php $__currentLoopData = $ClaStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ClaStudent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><b><?php echo e($ClaStudent->surname); ?></b>
                                                                    <?php echo e($ClaStudent->name); ?> </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php $__empty_1 = true; $__currentLoopData = $testsTF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <span
                                                                            class="<?php if($test->type == 1): ?> badge badge-primary <?php elseif($test->type == 2): ?> badge badge-success <?php else: ?> badge badge-dark <?php endif; ?> ml-1"
                                                                            style="font-size: 20px; width:65px;">
                                                                            <b><?php echo e($test->testNum); ?></b>
                                                                            <hr class="hrr">
                                                                            <input type="number" step="0.01"
                                                                                name="<?php echo e($ClaStudent->id); ?>"
                                                                                min="0" max="20"
                                                                                class="form-control"
                                                                                style="padding: 2px 2px;">
                                                                            <input type="hidden" class="form-control"
                                                                                name="classroom_id"
                                                                                value="<?php echo e($subject->classroom->id); ?>"
                                                                                hidden="">
                                                                            <input type="hidden" class="form-control"
                                                                                name="test_id"
                                                                        ...
                                                                        <?php if($ClaStudent === end($ClaStudents)): ?>
                                                                            <div class="pt-1">
                                                                                <button type="submit"
                                                                                    class="btn <?php if($test->type == 1): ?> btn-primary <?php elseif($test->type == 2): ?>  btn-success <?php else: ?>  btn-dark <?php endif; ?> pt-2">
                                                                                    Valider
                                                                                </button>
                                                                            </div>
                                                    </form>
                                                    ...
                                                    <button type="button" class="btn btn-danger pt-2"
                                                        data-toggle="modal" data-target="#T<?php echo e($test->id); ?>">
                                                        Supprimer <i class="icon-trash"></i>
                                                    </button>
                                                    <!-- Modal DELETE SAISI DE testTF -->
                                                    <div class="modal fade" id="T<?php echo e($test->id); ?>" tabindex="-1"
                                                        role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <form action="<?php echo e(URL::to('/teacher/DeleteTest')); ?>"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="text-center">
                                                                            ...
                                                                            <p>Voulez-vous vraiment supprimer cette saisie
                                                                                de note?</p>
                                                                            <p class="<?php if($test->type == 1): ?> badge badge-primary <?php elseif($test->type == 2): ?> badge badge-success <?php else: ?> badge badge-dark <?php endif; ?>"
                                                                                style="font-size: 15px;">
                                                                                <?php echo e($subject->name); ?> / <?php if($test->type == 1): ?>
                                                                                    Interrogation
                                                                                <?php elseif($test->type == 2): ?>
                                                                                    Devoir
                                                                                <?php else: ?>
                                                                                    Examen
                                                                                <?php endif; ?>
                                                                                N<?php echo e($test->testNum); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <?php $__currentLoopData = $testsFD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(!empty($mark)): ?>
                            <a class="btn text-white mr-2 <?php if($test->type == 1): ?> btn-primary <?php elseif($test->type == 2): ?> btn-success <?php elseif($test->type == 3): ?> btn-dark <?php endif; ?> ml-1 "
                                href="#" data-toggle="modal"
                                data-target="<?php if($subject->arretDesNotes == 0): ?> #M<?php echo e($mark->id); ?> <?php endif; ?>"
                                style="font-size: 20px;">
                                <b><?php echo e($test->testNum); ?></b>
                                <hr class="hrr">
                                <?php if($mark->value == null): ?>
                                    Nul <?php else: ?><?php echo e($mark->value); ?>

                                <?php endif; ?>
                            </a>
                            <!-- Modal Edit Mark -->
                            <div class="modal fade" id="M<?php echo e($mark->id); ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Modifier cette note de
                                                l'etudiant <b><?php echo e($ClaStudent->surname); ?> <?php echo e($ClaStudent->name); ?></b> </h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <form action="<?php echo e(URL::to('/teacher/EditMark')); ?>" method="post"
                                                    enctype="multipart/form-data" id="theform4">
                                                    <span
                                                        class="<?php if($test->type == 1): ?> badge badge-primary <?php elseif($test->type == 2): ?> badge badge-success <?php else: ?> badge badge-dark <?php endif; ?>"
                                                        style="font-size: 20px; width:65px;">
                                                        <?php echo e($test->testNum); ?>

                                                        <hr class="hrr">
                                                        <input type="number" step="0.01" name="value"
                                                            min="0" max="20"
                                                            placeholder="<?php if($mark->value == null): ?> Nul <?php else: ?><?php echo e($mark->value); ?> <?php endif; ?>"
                                                            class="form-control" required style="padding: 2px 2px;">
                                                        <input type="hidden" class="form-control" name="mark_id"
                                                            value="<?php echo e($mark->id); ?>" hidden="">
                        ...
                        <?php else: ?>
                            <a class="btn text-white mr-2 <?php if($test->type == 1): ?> btn-primary <?php elseif($test->type == 2): ?> btn-success <?php elseif($test->type == 3): ?> btn-dark <?php else: ?> btn-danger <?php endif; ?> ml-1 "
                                href="#" data-toggle="modal" data-target="#M<?php echo e($test->id); ?>"
                                style="font-size: 20px;">
                                <?php echo e($test->testNum); ?>
                            ...
                            <!-- Modal CreateAbsMark -->
                            <div class="modal fade" id="M<?php echo e($test->id); ?>" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <form action="<?php echo e(URL::to('/teacher/CreateAbsMark')); ?>" method="post"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Modifier cette note de
                                                    l'etudiant <b><?php echo e($ClaStudent->surname); ?> <?php echo e($ClaStudent->name); ?></b>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="hidden" class="form-control" name="student_id"
                                                            value="<?php echo e($ClaStudent->id); ?>" hidden="">
                                                        <input type="hidden" class="form-control" name="test_id"
                                                            value="<?php echo e($test->id); ?>" hidden="">
                                                        <input type="hidden" value="<?php echo e(csrf_token()); ?>"
                                                            name="_token">
                                                    </span><br> <br>
                    ...
                    <td> <!-- START CALCULE DE MOYENNE -->
                        ...
                        <strong>
                            ...
                            <span
                                class="<?php if($subjectavg): ?> <?php if($subjectavg->valueGrle >= 10): ?> badge btn-vert text-white <?php else: ?> badge badge-danger text-white <?php endif; ?>
<?php else: ?>
badge btn-vert text-white  <?php endif; ?>  "
                                style="font-size: 20px; width:65px;">
                                <?php if($subjectavg): ?>
                                    <?php echo e($subjectavg->valueGrle); ?>
                    ...
                    <td> <!-- START RANK -->
                        ...
                        <strong>
                            ...
                            <span class=" badge badge-secondary text-white " style="font-size: 20px; width:65px;">
                                <?php if($subjectavg): ?> <?php echo e($subjectavg->rank); ?>
                        ...
                        <tr>
                            ...
                            <?php if(!empty($testsFD) >= 1): ?>
                                ...
                                <td>
                                    <?php $__currentLoopData = $testsFD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button
                                            class="<?php if($test->type == 1): ?> btn btn-primary <?php elseif($test->type == 2): ?> btn btn-success <?php else: ?> btn btn-dark <?php endif; ?> ml-1"
                                            data-toggle="modal" data-target="#TFD<?php echo e($test->id); ?>">
                                            <?php if($test->type == 1): ?>
                                                Interrogation <?php echo e($test->testNum); ?>

                                            <?php elseif($test->type == 2): ?>
                                                Devoir <?php echo e($test->testNum); ?>

                                            <?php else: ?>
                                                Examen <?php echo e($test->testNum); ?>

                                            <?php endif; ?>
                                        </button>

                                        <!-- Modal DELETE testTF -->
                                        <div class="modal fade" id="TFD<?php echo e($test->id); ?>" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <form action="<?php echo e(URL::to('/teacher/DeleteMark')); ?>" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <input type="hidden" class="form-control" name="id"
                                                                    id="id" value="<?php echo e($test->id); ?>"
                                                                    hidden="">
                                                                <input type="hidden" value="<?php echo e(csrf_token()); ?>"
                                                                    name="_token">
                            ...
                            <div class="col-sm-6">
                                <div class="card card-body bg-secondary" style="color:white;">
                                    <h3><b>Interrogation</b> :
                                        <?php echo e($testsP->where('subject_id', $UniqueSubjTests[$i])->where('state', 1)->where('type', 1)->count()); ?>

                                    </h3>
                                    <h3><b>Devoir</b> :
                                        <?php echo e($testsP->where('subject_id', $UniqueSubjTests[$i])->where('state', 1)->where('type', 2)->count()); ?>

                                    </h3>
                                    <h3><b>Examen</b> :
                                        <?php echo e($testsP->where('subject_id', $UniqueSubjTests[$i])->where('state', 1)->where('type', 3)->count()); ?>
                    ...
                    <?php if($semesterP->arretDesNotes == 1 and !$subjectavg): ?>
                        ...
                        <p class="text-center">
                            <a href="#" class="btn btn-bordo" data-toggle="modal"
                                data-target="#exampleModal<?php echo e($subject->id); ?>">
                                <b>CALCULER LES MOYENNES</b>
                            </a>
                        </p>

                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal<?php echo e($subject->id); ?>" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <p class="text-center">En confirmant, les moyennes de cette
                                            matière<br><b>(<?php echo e($subject->name); ?>)</b><br> seront calculées et marquées
                                            définitives</p>
                    ...
                    <!-- Modal Edit teacher -->
                    <div class="modal fade" id="BCL<?php echo e($subject->id); ?>" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit teacher -->
                        <form action="<?php echo e(URL::to('/teacher/CreateSubjectAvg')); ?>" method="post"
                                ...
                                <div class="modal-content"> <!--MODAL CONTENT -->
                                    ...
                                    <div class="modal-body"> <!--MODAL BODY -->
                                        ...
                                        <input type="hidden" class="form-control" name="subject_id"
                                            value="<?php echo e($subject->id); ?>" hidden="">
                                        <input type="hidden" class="form-control" name="semester_id"
                                            value="<?php echo e($semesterP->id); ?>" hidden="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/teacher/mark.blade.php ENDPATH**/ ?>