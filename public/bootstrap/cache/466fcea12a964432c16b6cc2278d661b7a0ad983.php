...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <div class="col-sm-6"><!-- COL 6 -->
      ...
      <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MM1<?php echo e($student->id); ?>" ><b>MODIFIER</b></button></p> <!-- MODIFY BUTTON -->

    <!-- Modal Edit student -->
    <div class="modal fade" id="MM1<?php echo e($student->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit student -->
    <form action="<?php echo e(URL::to('/manager/modifyStudent')); ?>" method="post" enctype="multipart/form-data">
      <!--EDIT FORM-->
                ...
                <p class="text-center">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="classroom_id">
                          <option value=""><?php echo e($student->classroom->name); ?></option>
...
<!--END EDIT FORM-->
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD1<?php echo e($student->id); ?>" ><b>SUPPRIMER</b></button></p>

      <!-- Modal Delete student -->
      <div class="modal fade" id="MD1<?php echo e($student->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form action="<?php echo e(URL::to('/manager/deleteStudent')); ?>" method="post" enctype="multipart/form-data">
        <!--DELETE FORM-->
        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
...
<hr>
        ...
        <!--  </div>-->
<?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/getStudent1.blade.php ENDPATH**/ ?>