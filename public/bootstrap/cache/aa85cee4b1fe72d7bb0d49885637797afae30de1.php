    ...
    <div class="app">
      ...
      <div class="container-fluid"> <!-- container-fluid-->
          ...
          <div class="row">
            ...
            <form  action="/kuro/admin/CreateSchoolNews" method="post" enctype="multipart/form-data">
...
<!-- NEWS ACTUALITES -->
  ...
  <div class="row justify-content-md-center">
    ...
    <div class="card my-4">
        ...
        <img class="rounded-circle mt-4 mx-auto d-block" alt="directeur" width="200" height="200" src="/assets/img/directeur.jpg" alt="Card image">
        <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/admin/schoolNews.blade.php ENDPATH**/ ?>