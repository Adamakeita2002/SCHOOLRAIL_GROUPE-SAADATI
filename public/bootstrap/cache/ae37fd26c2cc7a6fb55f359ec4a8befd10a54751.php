...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <form action="<?php echo e(URL::to('/kuro/admin/modifyStudent')); ?>" method="post" enctype="multipart/form-data" id="theform2">
      <!--EDIT FORM-->
      <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
  ...
  $(function()
{
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD1<?php echo e($Ustudent->id); ?>" ><b>SUPPRIMER</b></button></p>
      ...
      <form action="<?php echo e(URL::to('/kuro/admin/deleteStudent')); ?>" method="post" enctype="multipart/form-data" id="theform3">
        <!--DELETE FORM-->
        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_GROUPE SAADATI\resources\views/admin/student.blade.php ENDPATH**/ ?>