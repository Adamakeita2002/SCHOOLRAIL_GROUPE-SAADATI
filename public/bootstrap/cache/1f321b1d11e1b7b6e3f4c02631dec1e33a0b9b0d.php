                    ...
                    <div class="col-sm-3 mt-3"> <!--START CALENDRIER -->
                        ...
                        <div class="calendar light mx-auto d-block">
                            ...
                            <div class="calendar_events">
                                ...
                                <?php $__currentLoopData = $calendars;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $calendar): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-3 mt-4">
                                <img src="/assets/img/logo-sabile-12x12-1.webp" class="img-fluid" width="263px" height="100px">
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/student/dashboard.blade.php ENDPATH**/ ?>