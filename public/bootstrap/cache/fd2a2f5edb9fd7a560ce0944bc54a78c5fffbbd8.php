...
<!-- STARTING -->
            ...
            <div class="row" >
              ...
              <span><!-- START Edit teacher -->
                ...
                <form action="<?php echo e(URL::to('/kuro/admin/modifyTeacher')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD<?php echo e($teacher->id); ?>" ><b>SUPPRIMER</b></button></p>
                ...
                <form action="<?php echo e(URL::to('/kuro/admin/deleteTeacher')); ?>" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_GROUPE SAADATI\resources\views/admin/editTEacher.blade.php ENDPATH**/ ?>