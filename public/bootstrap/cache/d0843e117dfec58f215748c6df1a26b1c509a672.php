...
<?php if(!empty($classroom)): ?> 
      <div class="row">
          ...
          <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#MRKQ1<?php echo e($student->id); ?><?php echo e($semesterP->id); ?>">
            <i class="icon-eye"></i><?php echo e($semesterP->label); ?> </a>|
          
          <!-- Modal Edit teacher -->
            <div class="modal fade" id="MRKQ1<?php echo e($student->id); ?><?php echo e($semesterP->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit teacher -->
      ...
      <h6 style="float: right;" >
       ...
       UE NON VALIDEE: <?php echo e($UENV); ?>
                ...
                <div class="modal-footer">
                  <form action="<?php echo e(URL::to('/manager/printBulletin1')); ?>" method="post" enctype="multipart/form-data" id="#theform<?php echo e($student->id); ?>">
                    <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
          ...
          <!-- Modal Edit teacher -->
            <div class="modal fade" id="MRKD2<?php echo e($student->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit teacher -->
              ...
              <div class="modal-dialog modal-lg" role="document"><!--MODAL DIALOG -->
                ...
                <div class="modal-body"> <!--MODAL BODY -->
                  <form action="<?php echo e(URL::to('/manager/printBulletin2')); ?>" method="post" enctype="multipart/form-data" id="theformed<?php echo e($student->id); ?>">
                    <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
                    <input type="hidden" name="id" value="<?php echo e($student->id); ?>">
                    <input type="hidden" name="academicyear_id" value="<?php echo e($classroom->academicyear->id); ?>">
                    <p class="text-center">TELECHARGER LES BULLETINS DISPONIBLES <br> <b><?php echo e($student->name); ?> <?php echo e($student->surname); ?></b></p>
...
<?php else: ?>
<h5 class="text-danger text-center"><b>AUCUNE CLASSE NE CORRESPOND A CETTE RECHERCHE DANS L'ANNEE SCOLAIRE DEFINIE</b></h5>
<?php endif; ?>

<?php /**PATH C:\Users\LENOVO T14\Desktop\SCHOOLRAIL_HETEC_V2\resources\views/manager/getBulletin1.blade.php ENDPATH**/ ?>