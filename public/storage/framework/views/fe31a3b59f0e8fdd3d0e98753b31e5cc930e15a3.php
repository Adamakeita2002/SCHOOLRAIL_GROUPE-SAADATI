  ...
  <?php use Carbon\Carbon;?>
    <div class="app">
      ...
      <div class="container-fluid"> <!-- container-fluid-->
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = $ressources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ressource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                <p><b>Professeur: </b> <?php echo e($ressource->teacher->name); ?> <?php echo e($ressource->teacher->surname); ?> <br>
        ...
        <p class="text-center">
          <button class="btn btn-danger"> AUCUNE RESSOURCE DES PROFESSEURS EN LIGNE </button>
        </p>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SCHOOLRAIL_HETEC\resources\views/manager/rteacher.blade.php ENDPATH**/ ?>