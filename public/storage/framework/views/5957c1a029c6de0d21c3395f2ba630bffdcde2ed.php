  ...
  <?php $school="activve" ;?>
    <div class="app">
      ...
      <div class="col-md-4">
        ...
        <!-- Categories Widget -->
    <div class="card my-4">
        <h5 class="card-header">Mot du president du BDE</h5>
      ...
      <div class="calendar light mx-auto d-block mb-2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SCHOOLRAIL_HETEC\resources\views/tutor/schoolBde.blade.php ENDPATH**/ ?>