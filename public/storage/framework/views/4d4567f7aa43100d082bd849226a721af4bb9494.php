                            ...
                            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card mb-4" id="N<?php echo e($new->id); ?>">
                                    ...
                                    <?php if(!empty($new->upload)): ?>
                                        <img class="card-img-top" src="/public/files/schoolNews/<?php echo e($new->upload); ?>"
                                            alt="IMAGE">
                                    <?php endif; ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card my-4">
                                ...
                                <img class="rounded-circle mt-4 mx-auto d-block" alt="directeur" width="200"
                                    height="200" src="public/assets/img/directeur.jpg" alt="Card image">
                                <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SCHOOLRAIL_HETEC\resources\views/student/schoolNews.blade.php ENDPATH**/ ?>