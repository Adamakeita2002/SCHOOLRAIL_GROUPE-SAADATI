      ...
      <div class="container-fluid"> <!-- container-fluid-->
         ...
         <?php $ressource=$ressources->where('id',$ltn->reference)->first(); ?> 
          ...
          @if($ltn->type =='MESSAGE')<h5><b>Message</b>   
           <a href="/student/message?q={{$ltn->reference}}&k=clicked#M{{$ltn->reference}}"> (voir le message)</a><span class="pull-right" style="font-size: 12px"> <b><i>{{$ltn->created_at->diffForHumans()}}</i></b> </span></h5>
          @endif
