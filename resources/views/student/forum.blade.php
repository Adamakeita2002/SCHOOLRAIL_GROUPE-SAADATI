  ...
  @endif
    <div class="app">
      ...
      <div class="col-md-8">
        ...
        <h1 class="my-4 card-header text-center bg-primary text-white">FORUM DE DISCUSSION</h1>
                  ...
                  <div class="collapse @if(isset($X) AND $X==$forum->id) show @endif" id="collapseExample{{$forum->id}}">
                    ...
                    @endif
                        ...
                        <div class="card-footer text-muted mt-2" style="background-color:rgba(117, 127, 134, 0.3);">
                          <p>- Commenté <b>{{$Bcomment->created_at->diffForHumans()}}</b> par <i><b><a href="#" >{{$Bcomment->student->name}} {{$Bcomment->student->surname}}</a></b></i> -
                          </p>
                          <p>
                      ...
                      <div class="row justify-content-end">
                        @if($student->gender =='M')
                        <img src="/assets/img/john-doe.png" class="rounded-circle" width="100" height="100">
                        @else
                        <img src="/assets/img/jane-doe.png" class="rounded-circle" width="100" height="100">
                        @endif
                        <div class="col-sm-9">

                          <form  action="/student/CreateCommentfrm" method="post" enctype="multipart/form-data" id="theform">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token">
