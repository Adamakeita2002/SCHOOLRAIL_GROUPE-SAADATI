...
@endforeach
  ...
  <div class="row">
    ...
    <div class="col-sm-6 ">
      <?php $UEV=$student->subjectavgs->where('valueGrle','>=',10)->count(); ?>
      <?php $UENV=$student->subjectavgs->where('valueGrle','<',10)->count(); ?>
  ...
  <div class="row">
    <div class="col-sm-6">
      <?php $UEVS=$student->subjectavgs->where('valueGrle','>=',10)->all(); ?>
      <?php $UENVS=$student->subjectavgs->where('valueGrle','<',10)->all(); ?>
      <?php $semesterAvg=$student->semesterAvgs->where('semester_id',$semesterP->id)->first(); ?>
