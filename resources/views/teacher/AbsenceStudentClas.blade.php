        ...
        <?php
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <hr>
                ...
                <p class="text-center">
                    <a href="/teacher/absence?q={{$classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()}}" class="btn btn-danger text-center"> <b>POINTER LES ABSENCES</b>  </a>
                </p>
                
                <p class="text-center">
                    <a href="/teacher/VoirAbsenceStudentClas?q={{$classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()}}" class="btn btn-success text-center"> <b>VOIR LES ABSENCES</b>  </a>
                </p>
