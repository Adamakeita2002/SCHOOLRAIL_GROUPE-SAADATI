          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <hr>
                <h4 class="card-title text-center">
                    <a href="/teacher/SressourceStudent?q={{$classrooms->where('name',$UniqueClassrooms[$i])->pluck('id')->first()}}" class="btn btn-success"> AFFICHER LES ELEVES DE CETTE CLASSE </a>
                </h4>
