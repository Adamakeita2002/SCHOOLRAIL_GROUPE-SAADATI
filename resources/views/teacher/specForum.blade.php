...
@section ('content')
  ...
  <?php $forum="activve" ;?>
    ...
    <div class="col-md-8">
      ...
      <h1 class="my-4 card-header text-center bg-primary text-white">FORUM DE DISCUSSION
        <b>({{$specFtheme->label}})</b>
      </h1>
                    ...
                    @if(!empty($Bcomment))
                      ...
                      <div class="row justify-content-end">
                        ...
                        <div class="col-sm-9">
                          ...
                          <form  action="/student/CreateCommentfrm" method="post" enctype="multipart/form-data">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token">
                            <div class="form-group">
                              ...
                              <input type="hidden" value="specF" name="create">
                              <input type="hidden" value="{{$specFtheme->label}}" name="link">
