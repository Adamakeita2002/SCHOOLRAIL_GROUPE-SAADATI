            ...
            <div class="form-group">
              ...
              <select class="form-control" name="classroom" onchange="showTimetable(this.value)">
                ...
                <?php  array_push($Class,$subject->classroom->id);  ?>
                  @if (in_array($subject->classroom->id , $Class) AND count($Class) <=1 )
...
<img class=" img-thumbnail card-img-top mx-auto d-block" src="/files/timetable/{{$UniqueClassrooms[$i]}}" style="width:1100px; height: 800px;" alt="{{$UniqueClassrooms[$i]}}" >
