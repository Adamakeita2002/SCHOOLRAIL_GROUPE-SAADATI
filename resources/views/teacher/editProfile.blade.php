          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="name" id="disabledInput" type="text" placeholder="{{$teacher->name}}" disabled>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="surname" id="disabledInput" type="text" placeholder="{{$teacher->surname}}" disabled>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="nationality" type="text" placeholder="{{$teacher->nationality}}">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                placeholder="@if (empty($teacher->dateofbirth)) JJ-MM-AA Ex: (20-12-1995) @else {{date_format($date,'d-m-Y')}} @endif"
            ...
            <div class="col-md-4">
              <div class="form-group ">
                ...
                <input type="tel" name="tel" placeholder="{{$teacher->tel}}" class="form-control" pattern="^[0-9-+s()]*$">
            ...
            <div class="col-md-4">
              <div class="form-group ">
                ...
                <input type="text" name="address" placeholder="{{$teacher->address}}" class="form-control">
