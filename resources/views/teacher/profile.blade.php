                ...
                <div class="col-sm-6 mt-3">
                    ...
                    <div class="card-body">
                      <h4 class="card-title">{{$teacher->name}} {{$teacher->surname}} </h4>
                          ...
                          <h6><b>Email: </b><br><span style="font-size: 14px">{{$teacher->email}}</span> </h6>

                          <h6><b>Telephone:</b> <br><span style="font-size: 14px">{{$teacher->tel}}</span> </h6>

                          <h6><b>Profession/Specialite:</b> <br><span style="font-size: 14px">{{$teacher->speciality}}</span> </h6>
          ...
          <div class="row">
            ...
            <tbody>
             ...
             <?php $Uclassroom=$classrooms->where('id',$UniqueClasSubjs[$i])->first();?>
                ...
                <td>
                  {{$students->where('classroom_id',$Uclassroom->id)->where('responsable',1)->pluck('name')->first()}} {{$students->where('classroom_id',$Uclassroom->id)->pluck('surname')->first()}} <br> <span><b>{{$students->where('classroom_id',$Uclassroom->id)->where('responsable',1)->pluck('tel')->first()}}<b></span></td>
                ...
                <p class="badge badge-dark" style="font-size: 15px;" >{{$ressource->title}} </p>
                  @endforeach
                @else
                <p class="badge badge-dark" style="font-size: 15px;" >Aucune ressource mise en ligne pour cette classe.
                </p>
                @endif
                </td>
                ...
                <td>
                  ...
                  <b>
                  ({{$Tsubject->name}} / {{$Tsubject->tests()->count()}})<br>
                  </b>
                  @endforeach
                ...
                <div class="col-sm-3 mt-3"> <!--START CALENDRIER -->
                   ...
                   ?>
                          ...
                          <div class="event_item">
                            ...
                            <div class="ei_Copy">
                              <p>
                                <b>{{$classrooms->where('id',$calendar->classroom_id)->pluck('name')->first()}} / {{$subjects->where('id',$calendar->subject_id)->pluck('name')->first()}}
                                </b> <br>
