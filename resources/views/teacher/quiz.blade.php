...
@section ('content')
  ...
  <div class="row justify-content-md-center">
      ...
      <div class="col-md-8">
        ...
        @if (is_array($subject->questions) || is_object($subject->questions))
        @foreach($subject->questions->sortByDesc('id') as $question)
            ...
            <div class="card mb-4" id="Q{{$question->id}}">
              <div class="card-body" style="color:white; background:#51970ccc !important; ">
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <h2 class="card-title">{{$question->title}} <b>({{$question->classroom->name}})</b></h2>
