          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <div class="row" > 
              ...
              <span><!-- START Edit classroom -->
                <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MM{{$classroom->id}}" ><b>MODIFIER</b></button></p>
                <!-- Modal Edit classroom -->
                <div class="modal fade" id="MM{{$classroom->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/manager/modifyClassroom') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD{{$classroom->id}}" ><b>SUPPRIMER</b></button></p>
                <!-- Modal Delete classroom -->
                <div class="modal fade" id="MD{{$classroom->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/manager/deleteClassroom') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
