          ...
          <div class="accordion pt-2 pb-2"  id="accordionExample{{$student->classroom->id}}">
            ...
            <tbody>
              ...
              <tr> 
                ...
                <td> <b>Aucun Versement</b> </td>
                  ...
                  <td>
                    <?php $i =1;  ?>
                    @foreach($student->versements->where('type',$x) as $versement) 
                    <span class="badge @if($x==4)btn-frose 
              ...
              <div class="row">
                  <div class="col-sm-6">
                    <form></form>
                    <form action="/manager/@if($x==4)CreateTenuClasse 
                    ...
                    @endif"
                     id="sco{{$student->id}}" method="post" enctype="multipart/form-data">
                      ...
                      <input type="number" class="form-control" name="amount" placeholder="Montant" required="">
                      <button type="submit" class="btn @if($x==4)btn-frose 
                    @elseif($x==5)btn-frose 
                    @elseif($x==6)btn-forange
                    @elseif($x==7)btn-forange
                    @elseif($x==8)btn-forange
                  ...
                  <div class="col-sm-6">
                    <form></form>
                    <form action="/manager/@if($x==4)CreateTenuClassePrint 
