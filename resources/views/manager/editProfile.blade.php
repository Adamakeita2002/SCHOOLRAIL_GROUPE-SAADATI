          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="name" type="text" placeholder="{{$manager->name}}">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="surname" type="text" placeholder="{{$manager->surname}}" >
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group ">
                ...
                <input type="email" name="email" placeholder="{{$manager->email}}" class="form-control">
            ...
            <div class="col-md-4">
              <div class="form-group ">
                ...
                <input type="tel" name="tel" placeholder="{{$manager->tel}}" class="form-control" pattern="^[0-9-+s()]*$">
