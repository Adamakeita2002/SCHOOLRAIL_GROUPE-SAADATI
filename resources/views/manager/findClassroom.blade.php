            ...
            <div class="row">
              <div class="col-12 col-md-6 ">
                <div class="form-group">
                  ...
                  <select class="form-control" name="classroom" onchange="showClassroom2(this.value)">
...
function showClassroom2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getClassroom2?q="+str,true);
        xmlhttp.send();
    }
}
