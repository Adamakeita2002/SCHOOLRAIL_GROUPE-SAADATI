...
<hr>
 <!-- Page Heading -->
  <h4 class="my-4 text-center text-primary"> 
    <i class="fa fa-id-card" aria-hidden="true" style="font-size: 100px;" ></i><br>
    <span class="text-dark"><b>SCOLARITE D'UN ELEVE</b></span>  
  </h4>
 ...
 */
  ...
  xhttp.open("GET","/manager/getSco1?q="+student1,true);
  xhttp.send();
}
...
function showStudent2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getSco2?q="+str,true);
        xmlhttp.send();
    }
}
