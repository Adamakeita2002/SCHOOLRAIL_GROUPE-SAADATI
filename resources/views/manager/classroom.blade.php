...
<div class="col-md-9">
  ...
  <form  action="/manager/CreateClassroom" class="tab-content" method="POST" enctype="multipart/form-data">
    ...
    <div id="payment" class="tab-pane">
      ...
      <div id="payment-collapse" class="collapse" data-parent="#formOrder">
        ...
        <div class="col-md-12">
          <p class="text-center">
              <span > <button class="btn btn-dark" id="sample5" ><b>{{$academicyearP->labelYear}} </b></button> </span>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-9 col-lg-10">
                <div class="mb-2">{{$academicyearP->labelYear}}</div>
              </div>
            </div>
