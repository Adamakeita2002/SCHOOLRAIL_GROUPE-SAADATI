    ...
    <div class="app">
      ...
      <div class="container-fluid"> <!-- container-fluid-->
          <div class="row">
            ...
            <form  action="/manager/CreateTutor" method="post" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            @endforeach
              ...
              <span class="text-danger"> <b>Cet tuteur n'a aucun enfant</b></span>
               ...
               <form action="{{ URL::to('/manager/affectationTutor1') }}" method="post" enctype="multipart/form-data">
                <input type="hidden" value="{{ csrf_token() }}" name="_token">
...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <form action="{{ URL::to('/manager/modifyTutor1') }}" method="post" enctype="multipart/form-data">
      <!--EDIT FORM-->
      <input type="hidden" value="{{ csrf_token() }}" name="_token">
