...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <form action="{{ URL::to('/manager/modifySubject1') }}" method="post" enctype="multipart/form-data">
      <!--EDIT FORM-->
...
<!--END EDIT FORM-->
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MDS1{{$subject->id}}" ><b>SUPPRIMER</b></button></p>
      ...
      <form action="{{ URL::to('/manager/deleteSubject1') }}" method="post" enctype="multipart/form-data">
        <!--DELETE FORM-->
        <input type="hidden" value="{{ csrf_token() }}" name="_token">
...
@else
<h3 class="text-danger text-center"><b>CE PROFESSEUR N'ENSEIGNE AUCUNE MATIERE</b></h3>
@endif
