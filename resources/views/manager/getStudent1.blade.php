...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <div class="col-sm-6"><!-- COL 6 -->
      ...
      <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MM1{{$student->id}}" ><b>MODIFIER</b></button></p> <!-- MODIFY BUTTON -->

    <!-- Modal Edit student -->
    <div class="modal fade" id="MM1{{$student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit student -->
...
<!--END EDIT FORM-->
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD1{{$student->id}}" ><b>SUPPRIMER</b></button></p>

      <!-- Modal Delete student -->
      <div class="modal fade" id="MD1{{$student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
