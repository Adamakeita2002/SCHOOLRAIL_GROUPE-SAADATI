 ...
 */
  ...
  xhttp.open("GET","/manager/getRessource1?q="+ressource1,true);
  xhttp.send();
}
...
function showRessource2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getRessource2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showRessource3() {
  ...
  xhttp.open("GET","/manager/getRessource3?q="+ressource3,true);
  xhttp.send();
}
