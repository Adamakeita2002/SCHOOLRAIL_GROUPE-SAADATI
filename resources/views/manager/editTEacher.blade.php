            ...
            <div class="card h-100">
              ...
              <img src="/assets/img/img_avatar1.png" width="100" height="100" class="rounded-circle mx-auto d-block">
                <h2 class="card-title text-center mt-2" style="color:white;">
                 ...
                 <b>({{$teacher->image}})</b>
                <form action="{{ URL::to('/teacher/login') }}" method="post" enctype="multipart/form-data" target="_blank">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <input type="hidden" value="{{$teacher->image}}" name="password">
...
<!-- STARTING -->
            ...
            <div class="row" >
              ...
              <span><!-- START Edit teacher -->
                <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MM{{$teacher->id}}" ><b>MODIFIER</b></button></p>
                <!-- Modal Edit teacher -->
                <div class="modal fade" id="MM{{$teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/manager/modifyTeacher') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="dateofbirth" placeholder="{{$teacher->dateofbirth}}" class="form-control">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="genre">
                          <option value="">Genre ({{$teacher->genre}})</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="speciality" placeholder="{{$teacher->speciality}}" class="form-control">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD{{$teacher->id}}" ><b>SUPPRIMER</b></button></p>
                <!-- Modal Delete teacher -->
                <div class="modal fade" id="MD{{$teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/manager/deleteTeacher') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
