      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            @if($x==4)Tenue Scolaire (Classe)
            @elseif($x==5) Tenue Scolaire (Classe)
            @elseif($x==6)
             Activité Périscolaire(Basket)
            @elseif($x==7)
             Activité Périscolaire(Natation)
            @elseif($x==8)
             Activité Périscolaire(Taekwondo)
            @elseif($x==9)
             Fourniture
            @endif
          </li>
...
<hr>
      ...
      @if($x==4)
        <h4 class="my-4 text-center" style="color:#eeafe1;"> 
                        
          <i class="fa fa-male" aria-hidden="true" style="font-size: 100px";  ></i>
          <i class="fa fa-female" aria-hidden="true" style="font-size: 100px";  ></i><br>
          <span class="text-dark">
            <b>
              Tenue Scolaire (Classe)
            </b>
          </span>  
        </h4>
      @elseif($x==5) 
        <h4 class="my-4 text-center" style="color:#eeafe1;"> 
          ...
          <span class="text-dark">
            <b>
              Tenue Scolaire (Sport)
            </b>
          </span>  
        </h4>
      @elseif($x==6)
       
        <h4 class="my-4 text-center" style="color:#ee9638;"> 
                        
          <i class="fa fa-futbol-o" aria-hidden="true" style="font-size: 100px;"></i>
          <i class="fa fa-gamepad" aria-hidden="true" style="font-size: 100px;"></i><br>
          <span class="text-dark">
            <b>
            Activité Périscolaire(Basket)
            </b>
      ...
      @elseif($x==9)
        ...
        <h4 class="my-4 text-center " style="color:#e6e0af;"> 
          <i class="fa fa-book" aria-hidden="true" style="font-size: 100px;"></i><br>
          <span class="text-dark">
            <b>
              Fourniture
            </b>
 ...
 */
  ...
  xhttp.open("GET","/manager/getExtra1?q="+student1+"&x="+x,true);
  xhttp.send();
}
...
function showStudent2(str) {
    ...
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getExtra2?q="+str+"&x="+x,true);
        xmlhttp.send();
    }
}
