          ...
          <div class="accordion pt-2 pb-2"  id="accordionExample{{$student->classroom->id}}">
            <div class="card " style="background-color: #0b06cc45 !important;">
              <div class="card-header bg-secondary " id="headingOne{{$student->classroom->id}}">
                <h2 class=" text-center mb-0">
                  <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseOne{{$student->classroom->id}}" aria-expanded="true" aria-controls="collapseOne{{$student->classroom->id}}">
            ...
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col"><b>VERSEMENTS (BUS)</b></th>
            ...
            <tbody>
              ...
              <tr> 
                ...
                <?php $V=$student->versements->where('type',3)->count();  ?>
              ...
              <div class="row">
                  <div class="col-sm-6">
                    <form></form>
                    <form action="/manager/CreateBus" id="sco{{$student->id}}" method="post" enctype="multipart/form-data">
                      <input type="hidden" value="{{ csrf_token() }}" name="_token">
                      <input type="hidden" value="{{$student->id}}" name="student_id">
                      <input type="number" class="form-control" name="amount" placeholder="Montant" required="">
                      <button type="submit" class="btn btn-success form-control  mt-1" ><b>Valider</b></button>
                    </form>
                  </div>  
                  <div class="col-sm-6">
                    <form></form>
                    <form action="/manager/CreateBusPrint" id="sco{{$student->id}}" method="post" enctype="multipart/form-data">
                      <input type="hidden" value="{{ csrf_token() }}" name="_token">
                      <input type="hidden" value="{{$student->id}}" name="student_id">
