...
<hr>
 <!-- Page Heading -->
  <h4 class="my-4 text-center text-warning"> 
    <i class="fa fa-cutlery" aria-hidden="true" style="font-size: 100px;"></i><br>
       <span class="text-dark"><b>FRAIS CANTINE</b></span> 
  </h4>
 ...
 */
  ...
  xhttp.open("GET","/manager/getCan1?q="+student1,true);
  xhttp.send();
}
...
function showStudent2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/manager/getCan2?q="+str,true);
        xmlhttp.send();
    }
}
