        ...
        <div class="row">
            ...
            @foreach ($ressources as $ressource)
              <tr>
                ...
                <td>
                <p><b>Professeur: </b> {{$ressource->teacher->name}} {{$ressource->teacher->surname}} <br>
              ...
              <div class="modal fade" id="R{{$ressource->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/manager/DeleteRessource') }}" method="post" enctype="multipart/form-data">
