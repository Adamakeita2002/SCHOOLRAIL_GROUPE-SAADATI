...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <div class="col-sm-6"><!-- COL 6 -->
      ...
      <p class="text-center"><button class="btn btn-warning text-white" data-toggle="modal" data-target="#MMTE1{{$teacher->id}}" ><b>MODIFIER</b></button></p> <!-- MODIFY BUTTON -->

    <!-- Modal Edit teacher -->
    <div class="modal fade" id="MMTE1{{$teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><!-- Modal Edit teacher -->
    <form action="{{ URL::to('/kuro/admin/modifyTeacher1') }}" method="post" enctype="multipart/form-data">
      <!--EDIT FORM-->
...
<!--END EDIT FORM-->
  ...
  <div class="col-sm-6"><!-- COL 6 -->
    ...
    <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MDTE1{{$teacher->id}}" ><b>SUPPRIMER</b></button></p>

      <!-- Modal Delete teacher -->
      <div class="modal fade" id="MDTE1{{$teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form action="{{ URL::to('/kuro/admin/deleteTeacher1') }}" method="post" enctype="multipart/form-data">
        <!--DELETE FORM-->
        <input type="hidden" value="{{ csrf_token() }}" name="_token">
