 ...
 */
  ...
  xhttp.open("GET","/kuro/admin/getSubject1?q="+subject1,true);
  xhttp.send();
}
...
function showSubject2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/kuro/admin/getSubject2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showSubject3() {
  ...
  xhttp.open("GET","/kuro/admin/getSubject3?q="+subject3,true);
  xhttp.send();
}
