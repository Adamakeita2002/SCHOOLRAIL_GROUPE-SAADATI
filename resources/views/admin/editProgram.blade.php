          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                {{$program->levelVar}} <br> {{$program->fullname}}
                    ...
                    @endif
                    @foreach ($program->classrooms->where('academiyear_id',$academicyearP) as $classroom)
                    <span> <a href=""> {{$classroom->name}} {{$classroom->code}} </a> </span> ,
                    @endforeach
                    </h6>
            <hr>
            <div class="row" >
              ...
              <span><!-- START Edit PROGRAM -->
                ...
                <form action="{{ URL::to('/kuro/admin/modifyProgram') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD{{$program->id}}" ><b>SUPPRIMER</b></button></p>
                ...
                <form action="{{ URL::to('/kuro/admin/deleteProgram') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
