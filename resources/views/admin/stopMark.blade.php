...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
     @include ('layouts.errors')
      <form  action="/kuro/admin/STOPNOTE" method="post" enctype="multipart/form-data">
            ...
            @if ($semesterP->arretDesNotes == 0)
              ...
              <div class="col-sm-4 pt-3 ">
                <div class="form-group">
                  <select class="form-control" name="stopNote">
                    <option value="">Voulez vous activer l'arrêt des notes ?</option>
                    <option value="1">ACTIVER L'ARRÊT DES NOTES</option>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p class="text-center">En confirmant, les moyennes de <br><b>({{$classroom->name}})</b><br> au compte du {{$semesterP->label}} seront calculées et marquées définitives</p>
                         <form  action="/kuro/admin/buildSemesterMoy" method="post" enctype="multipart/form-data" id="theform">
                           <input type="hidden" value="{{ csrf_token() }}" name="_token">
...
function showClassroom3() {
  ...
  xhttp.open("GET","/kuro/admin/getStopMark?q="+classroom3,true);
  xhttp.send();
}
