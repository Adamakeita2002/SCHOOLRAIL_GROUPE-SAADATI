...
@if($academicyearP->classrooms->count() >0 )
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form  action="/kuro/admin/CreateSmessage" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                  ...
                  @foreach ($classrooms1 as $classroom)
                    ...
                    <div class="form-group options checkbox1 ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" class="check1" required id="{{$classroom->id}}" value="{{$classroom->id}}"/>
                  ...
                  <div class="col col-md-4 col-lg-4">
                    <div class="form-group options checkbox2 ">
                      <label class="checkbox checkbox-success">
                          ...
                          <span class="check-mark"></span>Check me out out
                      </label>
                    </div>
                  </div>
                  @endif
                ...
                @endif
                  ...
                  @foreach ($classrooms2 as $classroom)
                    ...
                    <div class="form-group options checkbox2 ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" class="check2" required id="{{$classroom->id}}" value="{{$classroom->id}}"/>
                          <span class="check-mark"></span>{{$classroom->name}}
                      </label>
                    </div>
                  </div>
                ...
                @endif
                  ...
                  @foreach ($classrooms3 as $classroom)
                    ...
                    <div class="form-group options checkbox3 ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" class="check3" required id="{{$classroom->id}}" value="{{$classroom->id}}"/>
                          <span class="check-mark"></span>{{$classroom->name}}
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col col-md-4 col-lg-4">
                    <div class="form-group options checkbox4 ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" class="check4" required id="{{$classroom->id}}" value="{{$classroom->id}}"/>
                          <span class="check-mark"></span>{{$classroom->name}}
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col col-md-4 col-lg-4">
                    <div class="form-group options checkbox5 ">
                      <label class="checkbox checkbox-success">
                          <input type="checkbox" name="classroom[]" class="check5" required id="{{$classroom->id}}" value="{{$classroom->id}}"/>
                          <span class="check-mark"></span>{{$classroom->name}}
                      </label>
                    </div>
                  </div>
