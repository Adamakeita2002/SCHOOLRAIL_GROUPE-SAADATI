      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Recherche une filière</li>
          </ol>
        </nav>
  ...
  <ul class="nav nav-tabs mb-4">
    <li class="nav-item">
      <a href="#room" class="nav-link" data-toggle="tab">
        <i class="icon-magnifier"></i> RECHERCHER UN PROGRAMME
      </a>
    </li>
  </ul>
    ...
    <div id="room" class="tab-pane show active">
      <div class="mb-3">
        <a href="#room-collapse" data-toggle="collapse">
          <i class="icon-user"></i> RECHERCHER UN PROGRAMME
        </a>
      </div>
            ...
            <div class="row">
              <div class="col-12 col-md-6 ">
                <div class="form-group">
                  <label>Selectionner la filière</label>
                  <select class="form-control" name="program" onchange="showProgram2(this.value)">
...
function showProgram2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/kuro/admin/getProgram2?q="+str,true);
        xmlhttp.send();
    }
}
