       ...
       <div class="col-md-12">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <form  action="/kuro/admin/CreateRessourceDocument" method="post" enctype="multipart/form-data">
              ...
              <form  action="/kuro/admin/CreateRessourceLien" method="post" enctype="multipart/form-data">
              <input type="hidden" value="{{ csrf_token() }}" name="_token">
...
<hr>
         <!--   <div class="col-md-4">
            ...
            @else
            <h3 class="text-danger text-center">IL N'EXISTE AUCUNE CLASSE POUR LE PARTAGE DE RESSOURCE</h3>
            @endif
