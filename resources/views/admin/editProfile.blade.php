  ...
  <?php $profile="activvve" ;?>
    <div class="app">
      ...
      <!--    <h2 class="text-center text-secondary">N* Matricule: XMT-12398</h2>-->
          ...
          <form  action="/kuro/admin/EditProfile" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="name" type="text" placeholder="{{$admin->name}}">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" name="surname" type="text" placeholder="{{$admin->surname}}" >
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group ">
                ...
                <input type="tel" name="tel" placeholder="{{$admin->tel}}" class="form-control" pattern="^[0-9-+s()]*$">
