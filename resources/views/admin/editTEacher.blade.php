...
<!-- STARTING -->
            ...
            <div class="row" >
              ...
              <span><!-- START Edit teacher -->
                ...
                <form action="{{ URL::to('/kuro/admin/modifyTeacher') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD{{$teacher->id}}" ><b>SUPPRIMER</b></button></p>
                ...
                <form action="{{ URL::to('/kuro/admin/deleteTeacher') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
