      ...
      <!--END NAVBAR -->
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Rechercher une ressource</li>
          </ol>
        </nav>
  ...
  <ul class="nav nav-tabs mb-4">
    <li class="nav-item">
      <a href="#identifiant" class="nav-link active" data-toggle="tab">
        <i class="icon-magnifier"></i> RECHERCHER PAR DATE
      </a>
    </li>
    <li class="nav-item">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                ...
                <label for =""> Entrer la date</label>
                  <input required="" class="form-control" type="date" id="ressource1" placeholder="LA DATE"  >
                </div>
              </div>

              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group mt-4">
                   <input class="btn btn-primary btn-lg btn-block" type="submit" onclick="showRessource1();" value="RECHERCHER"> 
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 col-md-6 ">
                <div class="form-group">
                  ...
                  <select class="form-control" name="classroom" onchange="showRessource2(this.value)">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="teacher_fullname" id="ressource3" class="form-control" placeholder="Déterminer le professeur" list="teacher_fullname"/>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group mt-4">
                   <input class="btn btn-primary btn-lg btn-block" type="submit" onclick="showRessource3();" value="RECHERCHER"> 
                </div>
              </div>
            </div>
          </div>
...
function showRessource1() {
  
  var s1 = document.getElementById('ressource1');
  var ressource1 = s1.value ;
 /* 
    if(s1.value == "") {
 ...
 */
  ...
  xhttp.open("GET","/kuro/admin/getRessource1?q="+ressource1,true);
  xhttp.send();
}

/*******************************************/

function showRessource2(str) {
    if (str == "") {
      ...
      //  xmlhttp.open("GET","getuser?q="+str+"&country="+country,true);
        xmlhttp.open("GET","/kuro/admin/getRessource2?q="+str,true);
        xmlhttp.send();
    }
}
...
function showRessource3() {
  
  var s3 = document.getElementById('ressource3');
  var ressource3 = s3.value ;  
  ...
  xhttp.open("GET","/kuro/admin/getRessource3?q="+ressource3,true);
  xhttp.send();
}
