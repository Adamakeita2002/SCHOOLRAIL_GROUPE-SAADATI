      ...
      <div class="col-sm-2">
          ...
          <div class="card-body">
            ...
            @endforeach
              ...
              <span class="text-danger"> <b>Cet tuteur n'aucun enfant</b></span>
               ...
               <form action="{{ URL::to('/kuro/admin/affectationTutor') }}" method="post" enctype="multipart/form-data">
        ...
        <hr>
          ...
          <hr>
                ...
                <h4 class="card-title " ><b> Mot de Passe : </b>
                  <span>{{$Ututor->image}}</span>
                </h4>
          <hr>
...
<!-- GENJUTSU --> <form ></form> <!-- GENJUTSU -->
  ...
  <div class="row">
    ...
    <form action="{{ URL::to('/kuro/admin/modifyTutor') }}" method="post" enctype="multipart/form-data">
      <!--EDIT FORM-->
      <input type="hidden" value="{{ csrf_token() }}" name="_token">
