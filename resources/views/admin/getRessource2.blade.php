<?php use Carbon\Carbon;?>
      ...
      <div class="container-fluid"> <!-- container-fluid-->
        ...
        <div class="row">
            ...
            @foreach ($classroom->ressources->sortByDesc('created_at') as $ressource)
              <tr>
        ...
        @if($classroom->ressources->count() <= 0 )
        <p class="text-center">
          <button class="btn btn-danger"> AUCUNE RESSOURCE EN LIGNE DANS CETTE CLASSE  </button>
        </p>
        @endif
