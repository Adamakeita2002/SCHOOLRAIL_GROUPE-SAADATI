          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                <b>Email</b> <br> {{$manager->email}}
                </h4>

                <h4 class="card-title text-center">
                <b>Mot de passe </b><br> {{$manager->image}}
                </h4>

                <h4 class="card-title text-center">
                <b>Téléphone</b> <br> {{$manager->tel}}
                </h4>
              <h6>
                <p class="text-center"> <a href="/kuro/admin/affectManager?q={{$manager->id}}" class="btn btn-warning"><b>Rôles du manager</b></a></p>
                 <!-- Button trigger modal -->
                <p class="text-center"> <a href="/kuro/admin/manager/delete" class="btn btn-danger" data-toggle="modal" data-target="#M{{$manager->id}}"><b>Supprimer le manager</b></a></p>

                  </div>

              <!-- Modal -->
              <div class="modal fade" id="M{{$manager->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ URL::to('/kuro/admin/DeleteManager') }}" method="post" enctype="multipart/form-data" id="theform3">
                ...
                <div class="modal-dialog" role="document">
                  ...
                  <div class="text-center">
                    ...
                    <p><b>NOM: </b> {{$manager->name}} <br>
                    <b>PRENOM: </b> {{$manager->surname}} <br>
                    <b>EMAIL: </b> {{$manager->email}} <br>
                    </p>

                    <input type="hidden" class="form-control" name="id" id="id" value="{{$manager->id}}" hidden="">
