    ...
    <div class="app">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form  action="/kuro/admin/CreateTmsg" method="post" enctype="multipart/form-data">
                    ...
                    @foreach ($teachers as $teacher)
                      ...
                      <div class="form-group options checkbox1 ">
                        <label class="checkbox checkbox-success">
                            <input type="checkbox" name="teacher[]" class="check1" id="{{$teacher->id}}" value="{{$teacher->id}}"/>
                            <span class="check-mark"></span><b>{{$teacher->name}} {{$teacher->surname}}</b>
                        </label> <br>
                        ({{$teacher->email}})
                      </div>
                    </div>
