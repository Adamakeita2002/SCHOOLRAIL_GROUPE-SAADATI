            ...
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control" name="schoolyear" id="schoolyear" >
                    ...
                    <option value="{{$academicyear->id}}">{{$academicyear->labelYear}}</option>
                    @endforeach
                  </select>
                </div>
            </div>
 ...
 */
  ...
  xhttp.open("GET","/kuro/admin/getBulletin1?q="+cla+"&k="+schoolyear,true);
  xhttp.send();
}
 ...
 */
  ...
  xhttp.open("GET","/kuro/admin/getBulletin2?q="+stud+"&k="+year,true);
  xhttp.send();
}
