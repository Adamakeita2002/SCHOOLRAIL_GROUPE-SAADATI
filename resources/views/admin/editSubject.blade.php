          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <div class="row" > 
              ...
              <span><!-- START Edit subject -->
                ...
                <form action="{{ URL::to('/kuro/admin/modifySubject') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              ...
              <p class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#MD{{$subject->id}}" ><b>SUPPRIMER</b></button></p>
                ...
                <form action="{{ URL::to('/kuro/admin/deleteSubject') }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="{{ csrf_token() }}" name="_token">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
