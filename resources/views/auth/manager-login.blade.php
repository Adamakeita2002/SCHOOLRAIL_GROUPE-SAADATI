    ...
    <div class="container-fluid">
                ...
                <div class="login d-flex align-items-center ">
                    ...
                    <div class="container" style="margin: 0px auto">
                        <div class="row justify-content-center">
                            <div class="col-sm-12">
                                <img src="/assets/img/llogo-sabile-12x12-1.webp" alt="HETEC - MALI"
                                    class="img-fluid rounded mx-auto d-block" width="300px" height="300px">
                            </div>
                        </div> <br><br>
                            ...
                            <div class="col-3  h-125 bg-white">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    ?> " id="v-pills-home-tab"
                                        ...
                                        aria-selected="true">Professeur</a>
                                ...
                                <img src="/assets/img/logo-schoolrail.png" alt="Schoolrail" class="img-fluid" width="150px"
                                    height="150px">
                            </div>
      ...
      ?>" id="v-pills-home" role="tabpanel"
                                        ...
                                        <form role='form' method="POST" action="{{ route('manager.login.submit') }}">
                                            ...
                                            <div class="form-label-group">
                                                <input type="email" id="inputEmail2" name="email"
                                                    class="form-control" placeholder="Entrez votre adresse Email" required
                                                    autofocus>
                                    ...
                                    <div class="tab-pane fade <?php if (isset($option) and $option == 'tutor') {
                                        ...
                                        aria-labelledby="v-pills-messges-tab">

                                        <h3 class="login-heading mb-4 text-center"> Vous etes un <b>Tuteur ?</b> </h3>
                                        <h3 class="login-heading mb-4 text-center"> Connectez vous à votre compte <b>Tuteur
                                            </b></h3>
