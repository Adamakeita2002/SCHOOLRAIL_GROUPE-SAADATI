...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ecoles', function (Blueprint $table) {
            ...
            $table->string('commune_id', 100)->nullable();
            $table->string('zone1', 300)->nullable();
            $table->string('zone2', 300)->nullable();
            $table->string('latitude', 50)->nullable();
            $table->string('longitude', 50)->nullable();
            $table->string('emailEcole', 100)->nullable();
            $table->string('telEcole', 20)->nullable();
            ...
            $table->integer('academie_id')->nullable()->index('aca_etab');
