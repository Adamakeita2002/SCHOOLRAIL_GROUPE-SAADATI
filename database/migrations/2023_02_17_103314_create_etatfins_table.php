...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('etatfins', function (Blueprint $table) {
            ...
            $table->string('Pension', 100)->nullable();
            $table->string('Demi', 100)->nullable();
            $table->string('Ordre', 100)->nullable();
        });
    }
